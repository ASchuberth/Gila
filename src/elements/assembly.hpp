...
/** Each spring element added gets assembled onto the previous with
 * addElement().
 *
 *  For Example:
 ...
 *           \/  \/        \/  \/                  \/  \/
 *
 *      The 2nd displacement of the previously added element is set to be equal
 * to the 1st displacement of the element being added.
 *
 */
...
public:
  ...
  Assembly1D() : numUnknowns{0}, globalStiffMatrixSize{0} {
   ...
   *
   * @param spring 1D Spring element (elem::Spring1D) with spring constant (k)
   * defined
   */
  void addElement(const elem::Spring1D &spring) { elements.push_back(spring); }
